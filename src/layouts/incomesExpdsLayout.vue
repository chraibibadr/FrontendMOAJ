    ...
    <q-layout view="hHh Lpr lFf" style="background-color:rgb(244,246,250) ;" >
      <q-header   style="background-color:rgb(244,246,250) ;color: grey;" >
        <q-toolbar  >
          ...
          <q-toolbar-title class="text-light-blue-9  text-bold text-h5 " style="font-style: italic; font-family: Georgia; margin-left: 30%;">
           Gestion Des Revenus et Depenses
          </q-toolbar-title>
          ...
          <q-card class="bg-light-blue-10 q-ml-sm">
            <q-card-section>
              ...
              <template v-for="(item, index) in menuItem.items" :key="index">
                <q-item  clickable   @click="$router.push(item.link)">
                  <q-item-section  avatar>
