  ...
  <q-page class="  justify-center items-center">
    <div class="q-pa-lg q-mt-lg">
      <div class="row q-my-md ">
        <div class="col-6   ">
          <q-btn color="grey-6" flat rounded icon-right="history" label="Historique " no-caps @click="historique" />
        </div>
        <div class="col-6 ">
      ...
      <q-table style="border:1px transparent ;border-radius: 20px;" :rows="rows" :columns="columns" separator='none'
        ...
        @request="handleRequest" ref="table" hide-pagination no-data-label="rien n'est trouvé"
        ...
        <template v-slot:body=props>
          ...
          <q-tr class=" text-grey-6 text">
            ...
            <q-table dense style="width:100%" v-if="props.row==rows[0]" v-model:pagination="pagination1" hide-pagination
              flat separator='none' :rows=" rows[0].incomes" :columns="columns">
              ...
              <template v-slot:top>
                <div class="q-mt-xs">
                  <q-pagination v-model="pagination2.page" :max="pageNumber(rows[1].incomes.length)" size="sm"
                    direction-links :max-pages="5" color="light-blue-10" outline />
                </div>
              </template>
              <template v-slot:body="props">
