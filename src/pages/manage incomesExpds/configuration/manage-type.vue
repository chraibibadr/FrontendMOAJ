...
<template>
  <q-page class=" q-pa-lg  " >
          ...
          <q-card class="bg-light-blue-10" style="border:1px transparent ;border-radius: 8px; width: 700px; max-width: 80vw;">
            <q-card-section class="row items-center q-pb-none text-white text ">
             ...
             <q-form class="q-pa-md  " @submit.prevent="createOrUpdate" >
                ...
                <q-input class=" col-7" color="light-blue-9"  bg-color="white" filled  :class="{'error':v$.name.$error}"  v-model="state.name" label="Nom" >
              ...
              <q-card-actions class="q-pa-0" align="right">
    ...
    <div class=" row justify-center ">  
      <div class="col-10">  
            ...
            <template v-slot:top> 
             <q-input class="col-6" dense densdebounce="300"  v-model="filter" placeholder="Recherche" rounded outlined color="light-blue-9">
                ...
                <q-space />
                    ...
                    />
                        ...
                        <span v-if=" col.name!='action' &&  sortColumn == col.name" class="material-icons cursor-pointer">{{arrowIconName}}</span>
                    ...
                    <template v-slot:body="props" >
                        ...
                        <q-td key="name"  :props="props" >
                           {{props.row.name}}
                            ...
                            <q-btn  size="14px" class="q-mt-sm " round flat   @click="toUpdate(props.row.name),idOfRow(props.row._id), card = true ">
                          <q-icon name="edit" color="grey-5"  /> </q-btn>
                           <q-btn  size="14px" class="q-mt-sm " round flat   @click="idOfRow(props.row._id),confirm  = true">
                ...
                <q-card class="bg-light-blue-10"  >
                    ...
                    <span class="q-ml-sm text-white">Attention!La suppresion d'un type menera à la suppression <br/> des revenus et depenses liées à ce dernier..</span>
                    </q-card-section>
...
/********Interaction with DB******** */
                    ...
                    const originalRows=ref([]);
                      await  getAll('types/get',page+'/','','name',filter.value,sort).then(res=>{
                       if(res.status==200)
...
// create
     const createOrUpdate= function(){
      ...
      else { createObject('types',state.value).then((res)=>{
...
// helping functions
  ...
  // return
      return {
       ...
       confirm: ref(false),idOfRow,toUpdate,action,  card: ref(false),
