      ...
      <div class="row q-py-md fit  q-mt-md justify-between " style="border:2px solid transparent ;border-radius: 10px;">
        ...
        <div round class=" col-12 col-sm-4 ">
          ...
          <div class="row justify-center" style="font-size: 16px;">
            <p class="text-weight-medium text">{{state.email}}</p>
          </div>
          <div class="row justify-center q-ml-xl">
            <q-icon name="work" class="col-2 " size="xs" color="light-blue-10" />
            <p class="text-weight-medium text col-6 q-mt-md " style="font-size: 16px;">{{state.function.name}}</p>
          </div>
          <div class="row justify-center q-ml-xl">
            <q-icon name="apartment" class="col-2 " size="xs" color="light-blue-10" />
            <p class="text-weight-medium text col-6 q-mt-md " style="font-size: 16px;">{{state.department.name}}</p>
          </div>
          <div class="row justify-center q-ml-xl">
        ...
        <q-card round class="shadow-12 col-12 col-sm-6 " style="border-radius: 20px;height: 50%;">
          ...
          <q-card-section class=" q-mt-xs q-px-none">
            <div class=" q-pt-xl q-pb-lg  ">
              ...
              <div class="row q-ml-sm q-pb-lg">
                <q-input class="  col-11 " standout="bg-grey text-white" dense readonly v-model="state.lastname"
                  label="Prenom">
                </q-input>
              </div>
              ...
              <div class="row q-ml-sm q-pb-lg">
                <q-input class="  col-11 " standout="bg-grey text-white" dense readonly v-model="state.firstname"
                  label="Prenom">
                </q-input>
              </div>
            ...
            <div class="row  justify-end q-mr-sm ">
              <q-btn class="bg-light-blue-10 " @click="toUpdatePass" color="white" no-caps type="submit"
                label="Mot de passe" icon-right="key" />
            </div>
          </q-card-section>
