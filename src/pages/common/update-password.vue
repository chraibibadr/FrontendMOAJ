  ...
  <q-layout view="hHh lpR fFf" style="background-color:rgb(244,246,250) ;">
    ...
    <q-page-container class=" q-pa-lg justify-center ">
      ...
      <div class="row q-pa-lg fit justify-center items-center ">
        ...
        <q-card round class="shadow-15 col-12 col-sm-6 col-md-4  " style="border:1px transparent ;border-radius: 20px;">
          <q-card-section style=" background-color:rgb(244,246,250) ;  color: rgb(116,124,128) ;
                           ">
            <div class="row  justify-between">
              <div class="  q-my-sm  col-10 text-bold  " style="font-family:Georgia ;font-size: 16px;">Nouveau mot de
                passe</div>
          ...
          <q-card-section class="">
            <q-form class=" q-py-lg  " @submit.prevent="update">
              <div class="row q-ma-0  justify-center q-pb-lg">
                <q-input class="  col-12 " standout="bg-grey text-white"
                  :class="{'error':v$.pass.$error || !verifyPass}" v-model="state.pass" label="Mot de passe actuel">
              ...
              <div class="row q-ma-0   justify-center q-pb-lg">
                ...
                <q-input class=" col-12  " :type="isPwdC ? 'password' : 'text'" standout="bg-grey text-white"
                  :class="{'error':v$.newPass.$error}" v-model="state.newPass" label="Nouveau mot de passe">
                  ...
                  <template v-if="v$.newPass.$error" v-slot:prepend>
                    <q-icon round name="info" color="red">
                      ...
                      <q-tooltip v-else class="bg-red-5" :offset="[10, 10]">
                        Mot de passe doit contenir des lettres majiscule, <br />miniscule,des nombres et des caractére
                        speciaux
                      </q-tooltip>
                    </q-icon>
                  </template>
              ...
              <div class="row q-ma-0  justify-center q-pb-lg">
                <q-input class=" col-12" :type="isPwd? 'password' : 'text'" standout="bg-grey text-white"
                  :class="{'error':v$.confPass.$error}" v-model="state.confPass"
  ...
  setup() {
    ...
    const rules = computed(() => {
      return {
        pass: { required },
        newPass: {
          required, minLength: minLength(8), differentFromPass: function () {
    ...
    // return
    return {
      state, v$, update, verifyPass, isPwd: ref(true), isPwdC: ref(true), username,
