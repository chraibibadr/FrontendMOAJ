  ...
  <q-page class=" q-pa-lg  " >
          ...
          <q-card class="bg-light-blue-10" style="border:1px transparent ;border-radius: 8px; width: 700px; max-width: 80vw; ">
            <q-card-section class="row items-center q-pb-none text-white text ">
             <div class="text-h6">Gestion Des Departements</div>
            <q-space />
          ...
          <q-btn outline label="Anunler" color="white" v-close-popup />
            ...
            <template v-slot:top> 
             <q-input class="col-6" dense densdebounce="300"  v-model="filter" placeholder="Recherche" rounded outlined color="light-blue-9">
                ...
                <q-space />
                    ...
                    <template v-slot:body="props" >
                        ...
                        <q-td key="name"  :props="props" >
                            ...
                            <q-btn  size="15px" class="q-mt-sm " round flat   @click="toUpdate(props.row.name),idOfRow(props.row._id), card = true ">
                ...
                <q-card class="bg-light-blue-10"  >
                    ...
                    <span class="q-ml-sm text-white">Attention!La suppresion d'un departement menera à la suppression <br/> des utilisateurs liées à ce dernier..</span>
                    </q-card-section>
...
async function fetchData(page,sort){
                    const originalRows=ref([]);
                      await  getAll('departments/get',page+'/','','name',filter.value,sort).then(res=>{
                          ...
                          else   targgetNegative('Une erreur a été survenue lors du chargement');
...
// create
     const createOrUpdate= function(){
      ...
      else { createObject('departments',state.value).then((res)=>{
