        ...
        <q-card round class="shadow-15 col-sm-12 col-md-9 "  style="border:1px transparent ;border-radius: 20px;">
          <q-card-section  style=" background-color:rgb(244,246,250) ;  color: rgb(116,124,128) ;
            ...
            <div class="row  justify-between">
                  <div class="  q-my-sm text-bold col-sm-12 col-md-9  " style="font-family:Georgia ;font-size: 16px;">Nouveau Utilsateur </div>
                <div>
                  <q-icon name=" x edit"  size="16px" class="q-mb-sm" color="light-blue-10" > </q-icon>  <q-icon name="person" color="light-blue-10" size="28px" ></q-icon> 
                </div>  
            </div>
          </q-card-section>
          <q-separator  />
            ...
            <q-form class="q-px-sm q-pt-xl q-pb-lg  " @submit.prevent="update" >
              <div class="row q-ma-0  justify-between q-pb-lg">
                <div class="col-12 col-md-5 q-mb-lg">
                  <div class="row justify-between">
                     <q-input  class="  col-8 col-md-9 " standout="bg-grey text-white" disable v-model="state.matricule" label="Matricule" />
                     <div class="col-2 col-sm-1 items-center ">
                     <q-btn @click="getMatricule()"  size="12px" class="q-mt-sm " round flat ><q-icon size="24px" name="autorenew" color="grey-9"></q-icon> </q-btn>
                    </div>
                     <div class="col-2 items-center ">
                     <q-btn @click="copy(state.matricule)"  size="12px" class="q-mt-sm " round flat ><q-icon size="22px" name=" content_copy" color="grey-9"></q-icon> </q-btn>
                    </div>
              ...
              <div class="col-12 col-md-5">
                  <div class="row justify-between">
                        <q-input class=" col-8 col-md-9   " disable standout="bg-grey text-white" v-model="state.password" label="Password" />
                     <div class="col-2   col-sm-1 items-center ">
                     <q-btn @click="getPassword()"  size="12px" class="q-mt-sm " round flat ><q-icon size="24px" name="autorenew" color="grey-9"></q-icon> </q-btn>
                    </div>
                     <div class="col-2    items-center  ">
                     <q-btn @click="copy(state.password)"  size="12px" class="q-mt-sm " round flat ><q-icon size="22px" name=" content_copy" color="grey-9"></q-icon> </q-btn>
                    </div>
                     </div>
                </div>
             ...
             <!--Role-->
                ...
                <!--lastname && firstname-->
               <div class="row q-ma-0  justify-between q-pb-lg">
               <q-input class="  col-5 " standout="bg-grey text-white" :class="{'error':v$.firstname.$error}"  v-model="state.firstname" label="Prenom">
               ...
               <q-input class="  col-5 " standout="bg-grey text-white" :class="{'error':v$.lastname.$error}"  v-model="state.lastname" label="Nom" >
               ...
               <div class="row q-ma-0  justify-between q-pb-lg">
                  ...
                  <!--Email-->
               <q-input class=" col-5 self-end float-right"  :class="{'error':v$.email.$error}"  standout="bg-grey text-white"  v-model="state.email" label="Email" >
              ...
              <q-input class="  col-5 " :class="{'error':v$.phone.$error}"  standout="bg-grey text-white" type="tel" v-model="state.phone" label="Telephone">
              <template  v-if="v$.phone.$error"   v-slot:prepend>
               ...
               <!--fonction-->
               <q-select class=" col-5 self-end float-right" :class="{'error':v$.function.$error}"  standout="bg-grey text-white" 
               ...
               <!--department-->
               <q-select class=" col-5 self-end float-right" :class="{'error':v$.department.$error}"  standout="bg-grey text-white"
              ...
              <div class="row q-ma-0  justify-between q-pb-lg">
                 ...
                 <!--Role-->
                <q-select class=" col-5 self-end float-right "  :class="{'error':v$.role.$error}" standout="bg-grey text-white" 
                :options="Roles"
                option-label="name"
                v-model="state.role"
                label="Role" >
              ...
              <q-card-section  v-show="show" class="q-ma-xs " >
                ...
                <legend class="text-h6"  style="font-family:Georgia;color: grey;" :class="{'text-red-5':validatePermissions() && iscliked}">Permissions</legend>
                <div v-if="validatePermissions() && iscliked"  class="absolute-top-right q-pa-lg" style="transform: translateY(15%);">
               ...
               <q-select  class=" col-8 "  standout="bg-grey text-white" 
               v-model="stock" 
                option-label="name"
                :options="Permission"
                 label="Permissions" />
              ...
              <q-select  class=" col-8 "   standout="bg-grey text-white"
                ...
                :options="Permission"
                 ...
                 <div class="row  justify-evenly ">
                          <q-btn class="col-5 col-sm-3 col-md-2 text-bold " @click="reset()" type="button"  outline  color="light-blue-10" label="Annuler" />
