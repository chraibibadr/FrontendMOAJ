         <template>
                <q-page class=" q-pa-lg justify-center items-center">
                 ...
                 <template v-slot:top> 
                        ...
                        <q-space />
                       <q-select dense class="col-4 " :popup-content-style="{ color: 'grey' }"  color="light-blue-9"
                      
                       rounded outlined v-model="filterBy" 
                       :options="options"    
                   ...
                   />       
                    ...
                    />
                        ...
                        <span v-else-if="(col.name!='role'&& col.name!='permissions' && 
                                     col.name!='phone' &&  col.name!='email' && col.name!='action')" class="material-icons cursor-pointer">sort</span>
                        </q-th>
                        </q-tr>
                        ...
                        <q-td key="permissions" :props="props">
                           <q-icon round   name="visibility"  color="light-blue-10" size="22px" >
                              <q-tooltip class="bg-light-blue-10 text-white" id="app">
                                <strong v-if="props.row.role=='admin'">Toutes les applications <br/> sont <em>autorisées</em></strong>
