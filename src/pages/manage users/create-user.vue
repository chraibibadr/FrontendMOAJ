        ...
        <q-card round class="shadow-15 col-sm-12 col-md-9"  style="border:1px transparent ;border-radius: 20px;"  >
          <q-card-section  style=" background-color:rgb(244,246,250) ;  color: rgb(116,124,128) ;
            ...
            <div class="row  justify-between">
                  <div class="  q-my-sm text-bold col-10  " style="font-family:Georgia ;font-size: 16px;">Nouveau Utilsateur </div>
            ...
            <q-form class="q-px-sm q-pt-xl q-pb-lg  " @submit.prevent="create" >
              <div class="row q-ma-0  justify-between q-pb-lg">
                <div class="col-12 col-md-5 q-mb-lg">
                  <div class="row justify-between">
                     <q-input  class="  col-8 col-md-9 " standout="bg-grey text-white" disable v-model="matricule" label="Matricule" />
                     ...
                     <q-btn @click="copy(matricule)"  size="12px" class="q-mt-sm " round flat ><q-icon size="22px" name=" content_copy" color="grey-9"></q-icon> </q-btn>
                    </div>
              ...
              <div class="col-12 col-md-5">
                  <div class="row justify-between">
                        <q-input class=" col-8  col-md-9 " disable standout="bg-grey text-white" v-model="password" label="Password" />
                     <div class="col-2   col-sm-1 items-center ">
                     <q-btn @click="getPassword()"  size="12px" class="q-mt-sm " round flat ><q-icon  size="24px" name="autorenew" color="grey-9"></q-icon> </q-btn>
                    </div>
                     <div class="col-2    items-center  ">
                     <q-btn @click="copy(password)"  size="12px" class="q-mt-sm " round flat ><q-icon size="22px" name="content_copy" color="grey-9"></q-icon> </q-btn>
                    </div>
                     </div>
                </div>
             ...
             <!--Role-->
              ...
              <template  v-if="v$.phone.$error"   v-slot:prepend>
               ...
               <!--fonction-->
               <q-select class=" col-5 self-end float-right" :class="{'error':v$.fonction.$error}"  standout="bg-grey text-white" 
              ...
              <q-select  class=" col-8 "   standout="bg-grey text-white"
                ...
                :options="Permission"
                 ...
                 <div class="row  justify-evenly  ">
                          <q-btn class="col-5 col-sm-3 col-md-2 text-bold " @click="reset()" type="button"  outline  color="light-blue-9" label="Annuler" />
